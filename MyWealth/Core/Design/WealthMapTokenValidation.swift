...
enum WealthMapTokenValidation {
    ...
    static let requiredPlatforms: Set<String> = ["ios", "android", "web"]

    static func validateCatalog(data: Data) throws -> TokenCatalogValidationReport {
...
struct TokenCatalogValidationReport {
    let tokenCount: Int
